...
const Info = () => {
  return (
    <section className="w-full flex flex-col items-center justify-center">
      <div className="max-w-maxSectionWidth flex flex-col w-full relative paddings pb-12 min-h-screen">
        ...
        <div className="w-full h-full absolute left-0 top-0 z-[-1] flex justify-center">
          ...
          <div className="absolute left-0 top-0 w-full h-full bg-[#D101D5] bg-opacity-[0.3] z-10"></div>
